...
\input{content/Kapitel_1}
\input{content/Kapitel_2}
\input{content/Kapitel_3}
\input{content/Kapitel_4}
\input{content/Kapitel_5}
\input{content/Kapitel_6}
\input{content/Kapitel_7}
...
\cleardoublepage
\input{content/Anhang}		%Anhang hier einfügen
\end{document}